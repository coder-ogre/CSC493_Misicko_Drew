...
public class MenuScreen extends AbstractGameScreen
{
	...
	private CheckBox altMusicButton;
	//private RadioButton noMusicButton;
	...
	private void rebuildStage()
	{
		skinCanyonBunny = new Skin(
			Gdx.files.internal(Constants.SKIN_SCOOTERPUSHEEN_UI),
	...
	private Table buildOptWinAudioSettings()
	{
		...
		musicButton = new CheckBox("", skinLibgdx);
		altMusicButton = new CheckBox("", skinLibgdx);
		tbl.add(musicButton);
		tbl.add(new Label("Music", skinLibgdx));
		tbl.add(altMusicButton);
		tbl.add(new Label("AltMusic", skinLibgdx));
	...
	private Table buildOptWinSkinSelection()
	{
		...
		// + Skin preview image
		imgCharSkin = new Image(Assets.instance.pusheen.pusheenRegion);
	...
	private void loadSettings()
	{
		...
		musicButton.setChecked(prefs.music);
		altMusicButton.setChecked(prefs.altMusic);
	...
	private void saveSettings()
	{
		...
		prefs.music = musicButton.isChecked();
		prefs.altMusic = altMusicButton.isChecked();
	...
	private void onSaveClicked()
	{
		saveSettings();
		onCancelClicked();
		AudioManager.instance.onSettingsUpdated1();
		AudioManager.instance.onSettingsUpdated2();
	}
